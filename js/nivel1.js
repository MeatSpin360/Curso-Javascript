...
const variable = Number(prompt("Por favor asigne un valor del 1 al 100"));
...
if (variable > 10) {
    ...
    if (variable == 10) {
        ...
        console.log('la variable es menor a 10')
    }
};
...
let operador = prompt('elija una operacion matematica colocando el signo');

let var2 = 91;

if (operador === '+') {
    console.log(sumar(variable, var2))
} else if(operador === '-'){
        console.log(restar(variable, var2))
    } else if(operador === '*') {
            console.log(multiplicar(variable, var2))
        } else {
            console.log(dividir(variable, var2))
        };
